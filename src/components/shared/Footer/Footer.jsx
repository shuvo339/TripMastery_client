...
const Footer = () => {
    return (
        <footer className="mt-8  bg-[#044553]">
        <div className="md:footer flex flex-col md:flex-row md:justify-around items-center justify-end text-center md:gap-0 gap-6 px-4 md:px-28 py-10 text-base-content">
            <aside className="flex items-center justify-center flex-col">
               ...
               <p className='text-center text-white'>Providing reliable services since 2022</p>
            </aside>
            <nav>
        ...
        <div className="px-10 py-4 border-t border-cyan-700">
            <nav className="flex flex-col justify-center items-center">
                ...
                <p className="text-center text-white">Copyright © 2024 - All right reserved by Urban Dwellings</p>
            </nav>
        </div>
    </footer>
    );
